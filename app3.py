...
def map3_view():
    ...
    for data in weather_data_list:
        ...
        temperature_f = (data['temp'] * 9/5) + 32  # Cloud cover percentage
    ...
    grid_temperature = griddata((lons, lats), temperatures, (lon, lat), method='cubic')
    # Plot the contour map with color fill
    temp_levels = np.linspace(45, 100, 23)  # Increase the number of levels for a stronger gradient
    ...
    for city, coords in locations.items():
        ...
        temperature_f = (weather_data['temp'] * 9/5) + 32 
        ...
        if city == "Chicago":
            ...
            ax.text(LON, LAT + 0.01, f"{temperature_f:.1f}°F", color='white',  ha='center', fontsize=10, fontweight='bold',
        ...
        if city == "O'Hare Airport":
            ax.text(LON + 0.005, LAT + 0.0, f"{city}",
                    fontsize=8, color='white', zorder=1.8, transform=ccrs.PlateCarree(),
                    bbox=dict(facecolor='black', alpha=0.7, edgecolor='none', boxstyle='round,pad=0.1'))
            ax.text(LON, LAT + 0.01, f"{temperature_f:.1f}°F", color='white', fontweight='bold', ha='center', fontsize=10,
                transform=ccrs.PlateCarree(), bbox=dict(facecolor='black', alpha=0.7, edgecolor='none', boxstyle='round,pad=0.1'))
        ...
        if city == "Des Plaines":
            ax.text(LON + 0.005, LAT + 0.0, f"{city}",
                    fontsize=8, color='white', zorder=1.8, transform=ccrs.PlateCarree(),
                    bbox=dict(facecolor='black', alpha=0.7, edgecolor='none', boxstyle='round,pad=0.1'))
            ax.text(LON + 0.02, LAT + 0.01, f"{temperature_f:.1f}°F", color='white',  ha='center', fontsize=10, fontweight='bold',
                transform=ccrs.PlateCarree(), bbox=dict(facecolor='black', alpha=0.7,  edgecolor='none', boxstyle='round,pad=0.1'))
    ...
    ax.set_title(f"Surface Temperature Observations as of {formatted_time}")
